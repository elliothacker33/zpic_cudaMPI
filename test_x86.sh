...
# =========================================================================== #
# Test configuration for Fujitsu AMD EPYC ZEN 2                               #
...
# =========================================================================== #
# Lets use CLANG for a64FX optimizations
# Tests to make:
# - Run zpic with and without vectorization
# - Do a strong scalability ananlysis
# - Do a weak scalability analysis
# - Memory bandwidth utilization to check if its memory or cpu bound
# - Check if the code is getting optimizations cross-CMG
# - Energy effieciency / Comparing performance to energy spending
# =========================================================================== #
