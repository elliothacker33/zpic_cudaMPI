...
typedef struct EMF_ExternalField {
    ...
    float3Cpu E_0; ///< Value of uniform external E field
    float3Cpu B_0; ///< Value of uniform external B field

    float3Cpu (*E_custom)(int, float, void*);  ///< Custom external E-field function
    float3Cpu (*B_custom)(int, float, void*);  ///< Custom external B-field function
...
typedef struct EMF_InitialField {
    ...
    float3Cpu E_0; ///< Value for uniform initial E field
    float3Cpu B_0; ///< Value for uniform initial B field

    float3Cpu (*E_custom)(int, float, void*); ///< Custom initial E-field function
    float3Cpu (*B_custom)(int, float, void*); ///< Custom initial B-field function
...
typedef struct EMF {
    ...
    float3Cpu mur_fld[2]; ///< Field inside Mur boundary (lower/upper)
    float3Cpu mur_tmp[2]; ///< Previous Eperp for Mur boundary advance (lower/upper)
